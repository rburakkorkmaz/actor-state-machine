...
<Library LVVersion="24008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Go to Idle Msg.lvclass" Type="LVClass" URL="../Test State Messages/Go to Idle Msg/Go to Idle Msg.lvclass"/>
		<Item Name="Go to Init Msg.lvclass" Type="LVClass" URL="../Test State Messages/Go to Init Msg/Go to Init Msg.lvclass"/>
		<Item Name="Go To Work Msg.lvclass" Type="LVClass" URL="../Test State Messages/Go To Work Msg/Go To Work Msg.lvclass"/>
	</Item>
	<Item Name="Test State.lvclass" Type="LVClass" URL="../Test State/Test State.lvclass"/>
	<Item Name="Init.lvclass" Type="LVClass" URL="../Init/Init.lvclass"/>
	<Item Name="Idle.lvclass" Type="LVClass" URL="../Idle/Idle.lvclass"/>
	<Item Name="Work.lvclass" Type="LVClass" URL="../Work/Work.lvclass"/>
</Library>
