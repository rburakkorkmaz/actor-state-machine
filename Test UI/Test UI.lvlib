...
<Library LVVersion="24008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Change to Idle State Msg.lvclass" Type="LVClass" URL="../../Test UI Messages/Change to Idle State Msg/Change to Idle State Msg.lvclass"/>
		<Item Name="Change to Init State Msg.lvclass" Type="LVClass" URL="../../Test UI Messages/Change to Init State Msg/Change to Init State Msg.lvclass"/>
		<Item Name="Change to Work State Msg.lvclass" Type="LVClass" URL="../../Test UI Messages/Change to Work State Msg/Change to Work State Msg.lvclass"/>
		<Item Name="Update Log Msg.lvclass" Type="LVClass" URL="../../Test UI Messages/Update Log Msg/Update Log Msg.lvclass"/>
	</Item>
	<Item Name="Test UI.lvclass" Type="LVClass" URL="../Test UI.lvclass"/>
</Library>
